...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.70"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-v1",
      "problem_contract_sha256": "c133edae599c18b28b756b38b3906af9bf05d71a81fcce93fd591d65778277e5",
      "problem_id": "problem:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d",
      "route_id": "route:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-source-fidelity-01",
      "graph_id": "graph:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "A group $G$ is called an orientable Poincar\\'e duality group of dimension $n$ over a ring $R$ if it is of type $FP$ over $R$ and $H^i(G;RG)=0$ for $i\\ne n$, while $H^n(G;RG)=R$ as an $RG$-module, where the action on $R$ is trivial. (Note that $G$ is not required to be finitely presented.) If $G$ is an orientable Poincar\\'e duality group of dimension $n$ over all fields, is it an orientable Poincar\\'e duality group over the integers?"
          },
          "statement_sha256": "0b89c77675db97a22836cc74bcf0ec62056fc59574c28db8c8caa9f9aacee39c"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-root",
      "route_id": "route:um-kou-21.70-kourovka-notebook-problem-21.70-0407926d-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.70-d0a7ef3582fb",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.70"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
